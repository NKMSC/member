...
urlpatterns = patterns('',
  ...
  #  (r'^statics/(?P<path>.*)','django.views.static.serve',{'document_root':'member/statics'}), 
    ...
    url(r'^change_code$','member.views.change_code'),
    url(r'^change_code_result$','member.views.change_code_result'),
    url(r'^reset_code_request$','member.views.reset_code_request'),
    url(r'^reset_code/$','member.views.reset_code'),
    url(r'^reset_code_change/$','member.views.reset_code_change'),
    url(r'^reset_code_result$','member.views.reset_code_result'),
